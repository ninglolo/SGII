...
if __name__ == '__main__':
    ...
    r_cen = getRank(dataPath2+ sys.argv[2] + '_score.csv')
    ...
    f = open(savePath+sys.argv[1]+'_'+sys.argv[2]+'+GIC_performance.csv','w')
